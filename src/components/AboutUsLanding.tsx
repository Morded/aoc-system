...
const AboutUslanding = () => {
  return (
    <header className="w-full sm:min-h-[100vh] text-aocDark">
      <div className={`w-full h-[80vh] sm:h-[120vh] flex flex-col justify-start lg:justify-center items-start sm:items-center bg-aocOrange bg-[url(/noise.png)] px-4 xl:px-0`}>
