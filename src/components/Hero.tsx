  ...
  return (
    ...
    `}>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8 items-center">
        <div className="text-lg flex flex-col gap-6 col-span-1 order-1 md:order-0 text-center md:text-left items-center md:items-start">
        ...
        <div ref={gridItem} className="col-span-1 relative h-auto md:h-screen flex items-center justify-center order-0 md:order-1">
          ...
          <div className="h-[120vh] min-h-[800px] top-0 absolute w-56 bg-aocOrange opacity-20 z-[-1] invisible lg:visible"></div>
        </div>
      </div>
    </header>
  )
