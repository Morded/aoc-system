...
const ProductsHeader = () => {
  return (
    <section className="md:w-full max-w-6xl flex flex-col justify-center items-start sm:items-center h-screen md:my-96 px-4 xl:px-0 text-start md:text-center">
